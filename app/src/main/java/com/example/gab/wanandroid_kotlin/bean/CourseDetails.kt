...
/**
 * Created by 初夏小溪
 * data :2019/1/7 0007 11:35
 */
class CourseDetails : Serializable {
    ...
    class DataBean : Serializable {
        ...
        class GroupsBean : Serializable {
            ...
            class ActionsBean : Serializable {
                /**
                 * id : 2106
                 * title : 单腿两头起
                 * basis : 1
                ...
                var sort: Int = 0
                var notes: List<NotesBean>? = null
                var rules: List<RulesBean>? = null

                class NotesBean : Serializable {
                    /**
                     * name : 动作要点
                     * desc : ·双手伸直，腹肌发力起身
