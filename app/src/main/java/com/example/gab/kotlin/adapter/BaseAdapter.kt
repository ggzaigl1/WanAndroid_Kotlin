...
import com.example.gab.kotlin.bean.DatasItem
 ...
 */
class BaseAdapter(data: List<DatasItem>) : BaseQuickAdapter<DatasItem, BaseViewHolder>(R.layout.item_base_list, data) {
    ...
    private fun initImage(baseBean: DatasItem, imageView: AppCompatImageView) {
        if (baseBean.collect) {
